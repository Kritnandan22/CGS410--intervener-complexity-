    ...
    for rel in relations:
        for iid in rel.intervener_ids:
            ...
            row = {
                ...
                # bonus columns (not in final schema but useful for analysis)
...
def run_language(
    ...
    if not skip_baseline:
        ...
        # b) grammar-constrained baseline
...
def main():
    ...
    # --fast mode: skip heavy operations
