...
class NodeInfo:
    token: Token
    children: List[int] = field(default_factory=list)  # child token ids
    depth: int = 0
    subtree_size: int = 1
...
class DependencyTree:
    ...
    def _build(self):
        ...
        # Compute depth + subtree sizes from each root via DFS.
        # Starting from roots ensures correct post-order accumulation.
