...
class HypothesisTester:
    ...
    def per_sentence_zscores_with_ci(
        ...
        # Index real per-sentence means from features_df
        ...
        # Bootstrap 95% CI on mean z-score
        ...
        summary_df = pd.DataFrame([{
            ...
            "ci_excludes_zero_icm": ci_c_hi < 0,   # True = significantly supports ICM
            ...
            "ci_excludes_zero_dlm": ci_d_lo > 0,   # True = significantly supports DLM
    ...
    def ancova(
        ...
        try:
            ...
            ss_group  = model_reduced.ssr - model_full.ssr   # SS explained by adding group
    ...
    def power_analysis_n40(alpha: float = 0.05) -> Dict[str, Any]:
        ...
        try:
            ...
            # n needed for 80% power at medium effect
